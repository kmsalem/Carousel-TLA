...
\* Label P1 of process sendClientMessages at line 110 col 9 changed to P1_se
\* Label P1 of process nodeHandler at line 121 col 7 changed to P1_n
\* Process variable msg of process sendClientMessages at line 105 col 5 changed to msg_
\* Process variable serverStatus of process clientHandler at line 129 col 3 changed to serverStatus_
...
P1_(self) == /\ pc[self] = "P1_"
             ...
             /\ UNCHANGED << status, received, inChannels, stack, client_, 
                             ...
                             msg_, head, subsets, message, inMsg, 
                             serverStatus_ >>
...
P1_u(self) == /\ pc[self] = "P1_u"
              ...
              /\ \/ /\ serverStatus' = [serverStatus EXCEPT ![self] = "Committed"]
                    ...
                    /\ status' = [status EXCEPT ![node[self]] = incoming]
...
sendClientMessagesToServers(self) == P1_s(self)
...
P1(self) == /\ pc[self] = "P1"
            ...
            /\ IDSet' = Append(IDSet, inMsg'[self].id)
            /\ serverStatus_' = [serverStatus_ EXCEPT ![self] = inMsg'[self].serverStatus]
            /\ pc' = [pc EXCEPT ![self] = "Done"]
            /\ UNCHANGED << status, sent, received, channels, stack, msg, 
                            client_, server, tmp, node, serverMsg, incomingMsg, 
                            msgId, clientId, serverStatus, client, serverSet, 
                            msg_s, msg_, head, subsets, message >>

clientHandler(self) == P1(self)
