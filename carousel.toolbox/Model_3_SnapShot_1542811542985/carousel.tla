...
\* Procedure variable msg of procedure sendClientMessagesToServers at line 107 col 5 changed to msg_s
...
P0_(self) == /\ pc[self] = "P0_"
             /\ IF serverSet[self] # {}
                   THEN /\ \E selectedServer \in serverSet[self]:
                             ...
                             /\ /\ client_' = [client_ EXCEPT ![self] = client[self]]
                                /\ msg_c' = [msg_c EXCEPT ![self] = msg_s[self]]
             ...
             /\ UNCHANGED << IDSet, status, sent, received, channels, msg, id, 
